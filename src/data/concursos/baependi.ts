...
// Re-export pra retrocompat com imports antigos (`@/data/baependi`)
export type { Materia, Cargo } from './types';
export type Nivel = 'fundamental' | 'medio' | 'superior';
export { NIVEL_LABEL } from './types';
...
// ─── Retrocompat: helpers locais (sem param `concurso`) ───
...
// ─── Export canônico no formato Concurso (usado pelo registry novo) ───
export const concurso: Concurso = {
  slug: 'baependi',
  nome: 'Prefeitura de Baependi',
  municipio: 'Baependi',
  uf: 'MG',
  banca: 'INEPAM',
  bancaSlug: 'inepam',
